...
const appCss = "/assets/style-krVpN5UR.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-eyebrow mb-4", children: "Error 404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-7xl font-bold text-foreground", children: "Not Found" }),
...
const Route$2 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "SecurePath — Continuous Security Intelligence" },
      { name: "description", content: "SecurePath delivers obsidian-grade security scanning with strategic intelligence, compliance posture, and developer-ready remediation for engineering teams." },
      { name: "author", content: "SecurePath" },
      { property: "og:title", content: "SecurePath — Continuous Security Intelligence" },
      { property: "og:description", content: "Obsidian-grade security scanning, compliance posture, and developer-ready remediation." },
...
const $$splitComponentImporter$1 = () => import("./index-BiW2yaRG.js");
const Route$1 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./scan._scanId-CSB3I7el.js");
const Route2 = createFileRoute("/scan/$scanId")({
  ...
  head: ({
    ...
    meta: [{
      ...
      name: "description",
      content: "Security assessment report with AI-enriched findings, business impact, compliance mapping, and developer action plans."
    }]
  })
});
...
const ScanScanIdRoute = Route2.update({
  id: "/scan/$scanId",
  path: "/scan/$scanId",
  getParentRoute: () => Route$2
});
